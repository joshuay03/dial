  ...
  class Storage
    class TestMemcachedAdapter < Dial::Test
      ...
      def test_store_profile
        @mock_client.expect :set, true, [@profile_key, @profile_data, STORAGE_TTL]
      ...
      def test_store_with_custom_ttl
        custom_ttl = 7200
        @mock_client.expect :set, true, [@profile_key, @profile_data, custom_ttl]
      ...
      def test_fetch_profile
        @mock_client.expect :get, @profile_data, [@profile_key]
      ...
      def test_fetch_nonexistent_key
        @mock_client.expect :get, nil, [@profile_key]
      ...
      def test_delete
        @mock_client.expect :delete, true, [@profile_key]
